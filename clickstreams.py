...
# create folder: cs/graph/navitype: ALL, DB, LS, ES, EL, O
# create folder: cs/hopsoverlap/navitype: ALL, DB, LS, ES, EL, O

# nice -n10 python clickstreams.py -opt init -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/
# nice -n10 python clickstreams.py -opt filtering -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/
# nice -n10 python clickstreams.py -opt validation -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies
# nice -n10 python clickstreams.py -opt concepts -cs /bigdata/lespin/bioportal/clickstreams/
# nice -n10 python clickstreams.py -opt degreedist -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/
# nice -n10 python clickstreams.py -opt metadata -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/
# nice -n10 python clickstreams.py -opt toprequests -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -topk 99
# nice -n10 python clickstreams.py -opt plotnavitypes -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/
# nice -n10 python clickstreams.py -opt plotnavitypes -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -norm y
# nice -n10 python clickstreams.py -opt plotnavitypes -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -topk 99
# nice -n10 python clickstreams.py -opt plotnavitypes -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -topk 99 -norm y

# nice -n10 python clickstreams.py -opt sessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies -year 2015 -set filtered
# nice -n10 python clickstreams.py -opt plotsessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set filtered

# nice -n10 python clickstreams.py -opt sessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies -year 2015 -set valid
# nice -n10 python clickstreams.py -opt plotsessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid

# nice -n10 python clickstreams.py -opt sessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies -year 2015 -set valid -topk 99
# nice -n10 python clickstreams.py -opt plotsessions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99

# nice -n10 python clickstreams.py -opt transitions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y -navitype all
# nice -n10 python clickstreams.py -opt plottransitions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y -navitype all
# nice -n10 python clickstreams.py -opt plottransitions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y -navitype all -norm y
# nice -n10 python clickstreams.py -opt summary -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -year 2015 -set valid -topk 99 -withinonto y -navitype all

# parallel --tmpdir /bigdata/lespin/tmp/ -j5 nice -n10 python clickstreams.py -opt transitions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y -navitype {1} ::: all DB LS ES EL O
# parallel --tmpdir /bigdata/lespin/tmp/ -j5 nice -n10 python clickstreams.py -opt plottransitions -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y -navitype {1} -norm {2} ::: all DB LS ES EL O ::: y n
# parallel --tmpdir /bigdata/lespin/tmp/ -j5 nice -n10 python clickstreams.py -opt summary -cslog /bigdata/lespin/datasets/bioportal/clickstream/ -cs /bigdata/lespin/bioportal/clickstreams/ -on /bigdata/lespin/bioportal/ontologies/ -year 2015 -set valid -topk 99 -withinonto y -navitype {1} ::: all DB LS ES EL O

# DO NOT RUN - UNLESS YOU KNOW WHAT YOU ARE DOING # nice -n10 python clickstreams.py -opt hops -on /bigdata/lespin/bioportal/ontologies/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -set valid -topk 99 -withinonto y

# parallel --tmpdir /bigdata/lespin/tmp/ -j5 nice -n10 python clickstreams.py -opt hopsoverlap -on /bigdata/lespin/bioportal/ontologies/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -navitype {1} ::: DB LS ES EL O
# parallel --tmpdir /bigdata/lespin/tmp/ -j5 nice -n10 python clickstreams.py -opt hopsoverlapsummary -on /bigdata/lespin/bioportal/ontologies/ -cs /bigdata/lespin/bioportal/clickstreams/ -year 2015 -navitype {1} -rel {2} ::: DB LS ES EL O ::: O T MT RAW


# CHECK WHITE SPACE:
# /bigdata/lespin/bioportal/ontologies/graph/ERO_2016.adjlist
# /bigdata/lespin/bioportal/ontologies/graph/CARELEX_2016.adjlist


# 252MB (parallel)
# 804.471 records.
# 663.756 records after removing sessions with less than 2.
# 2018-04-01 18:40:16 --> 2018-04-01 18:42:01: 2min
# 2018-04-01 22:03:23 --> 2018-04-01 22:05:09

# 255M (sequential)
# 804.471 records.
# 663.833 records after removing sessions with less than 2.
# 2018-04-01 19:02:21 --> 2018-04-01 20:51:25: 2h 50min

# total 2015: 935276 records.
# 804471 total records after filtering out users (IPs) with less than 2 requests.
# --
# 577245 records after assigning seesionseq (valid)
# 450449 records after removing sessions with less than 2 clicks.
# --
# 570624 records after assigning seesionseq (valid+top99%)
# 445436 records after removing sessions with less than 2.
# --
# 570624 records after assigning seesionseq (valid+top99%+withinonto)
# 407969 records after removing sessions with less than 2.
# --
# 408 008
# 321 810
# 321 810 record (valid transitions)
#
# totals: (old)
# Sessions                 54.606
# Unique Transitions      164.672
# Multiple Transitions    185.280
# IPs                      27.145 unique (30.802 sum)
#
# totals:
# Sessions                 54 624
# Unique Transitions      164 689
# Multiple Transitions    185 315
# IPs                      30 804

# Sessions                 53 067.0
# Unique Transitions      172 550.0
# Multiple Transitions    196 173.0
# IPs                      29 952.0
    ...
    # #### to be removed
    # if 'ROOT' in Gt.nodes() and 'ROOT' not in Go.nodes():
    #     Gt.remove_node('ROOT')
    #     printf('ROOT removed')
    #
    # if 'OWL#THING' in Gt.nodes():
    #     printf('OWL#THING in Gt')
    #
    # if 'OWL#THING' in Go.nodes():
    #     printf('OWL#THING in Go')
    #
    # if 'OWL#THING' in Gt.nodes() and 'OWL#THING' not in Go.nodes():
    #     Gt.remove_node('OWL#THING')
    #     printf('OWL#THING removed from Gt')
    #
    # if 'OWL#THING' not in Gt.nodes() and 'OWL#THING' in Go.nodes():
    #     Go.remove_node('OWL#THING')
    #     printf('OWL#THING removed from Go')
    # #### to be removed




        # tmp = df.groupby(['_ontology', 'navitype', 'position']).size().reset_index().rename(columns={0: 'count'}).query("count >= {}".format(MINREQ))
        # mi = tmp.position.min()
        # ma = tmp.position.max()
        #
        # if params['set'] != 'valid':
        #     printf('ERROR: set must be \'valid\', {} give.'.format(params['set']))
        #     sys.exit(2)
        #
        # # ontos = df.ontology.unique()
        # colors = ['steelblue', 'mediumslateblue', 'indianred', 'seagreen', 'goldenrod']
        # types = df.navitype.unique()
        # id = 0
        #
        # fig, axes = plt.subplots(nrows=len(ontos), ncols=1, sharex=True, sharey=True)
        # for ontologyid, ontologyname in enumerate(ontos):
        #     tmp = df.query("_ontology=='{}'".format(ontologyname))
        #     tmp = tmp.groupby(['_ontology', 'navitype', 'position']).size().reset_index().rename(columns={0: 'count'})
        #     tmp = tmp.query("count >= {}".format(MINREQ))
        #
        #     for i, v in tmp.groupby('position')['count'].sum().iteritems():
        #         tmp.loc[tmp.position == i, 'count'] /= float(v)
        #
        #     if tmp.navitype.nunique() == len(types):
        #         id = ontologyid
        #
        #     for name, data in tmp.groupby('navitype'):
        #         data.sort_values('position').plot(ax=axes[ontologyid],
        #                                           label=name,
        #                                           x='position', y='count',
        #                                           sharex=True,
        #                                           sharey=True,
        #                                           legend=False,
        #                                           logx=True,
        #                                           color=colors[np.where(types == name)[0][0]])
        #         axes[ontologyid].set_ylabel(ontologyname, fontsize=12)
        #         axes[ontologyid].set_xlim((mi,ma))
        #         axes[ontologyid].set_ylim((0.0, 1.0))
        #
        # axes[id].legend(bbox_to_anchor=(0.85, 1.15), loc='center right', borderaxespad=0., bbox_transform=plt.gcf().transFigure, fontsize=12, ncol=len(types))
        # axes[-1].set_xlabel('position', fontsize=12)
        # plt.tick_params(axis='both', which='major', labelsize=12)
        # plt.tick_params(axis='both', which='minor', labelsize=12)
        # plt.subplots_adjust(top=1.15, bottom=0.1, left=0.10, right=0.95, hspace=0.35, wspace=0.35)
    ...
    #
    #         #printf('{} out of {} ({:.2f}%)'.format(i,total,(i*100.)/total)
    #         # for each ip
    #         for index, row in group.iterrows():
    #             if previous is None:
    #                 previous = row['timestamp']
    #                 df.loc[df.req_id == row.req_id, 'sessionid'] = sessionid
    #                 continue
    #
    #             current = row['timestamp']
    #             delta = get_delta_time(previous, current, TSFORMAT)
    ...
    #     printf('{} records.'.format(len(df)))
    #     printf('5. filtering out sessions with less than {} requests.'.format(MINREQ))
    #     df = df.groupby(['sessionid'], as_index=False).filter(lambda x: len(x) >= MINREQ)
    #     printf('{} records after removing sessions with less than {}.'.format(len(df), MINREQ))
    #     # end of sequential
    # else:
    #
    ...
    #     printf('Filtering...')
    #
    #     criterion1 = df['ontology'].map(lambda x: (x != 'nan' and x != 'NaN' and x != 'NAN' and x != '' and x is not np.nan))
    #     df = df[criterion1]
    #     df = df[pd.notnull(df['ontology'])]
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('+Ontology')
    #     printf('filter 1: {}'.format(df.shape[0]))
    #
    #     criterion2 = df['concept'].map(lambda x: (x != 'nan' and x != 'NaN' and x != 'NAN' and x != '' and x is not np.nan))
    #     df = df[criterion2]
    #     df = df[pd.notnull(df['concept'])]
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('+Concept')
    #     printf('filter 2: {}'.format(df.shape[0]))
    #
    #     criterion3 = df['request'].map(lambda x: 'p=classes' in x)
    #     df = df[criterion3]
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('+Classes')
    #     printf('filter 3: {}'.format(df.shape[0]))
    #
    #     criterion4 = df['request'].map(lambda x: 'callback=children' not in x)
    #     df = df[criterion4]
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('-Expand')
    #     printf('filter 4: {}'.format(df.shape[0]))
    #
    #     criterion5 = df['request'].map(lambda x: 'json_search' not in x or 'callback=jQuery' not in x)  # and instead of or
    #     df = df[criterion5]
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('-AJAX')
    #     printf('filter 5: {}'.format(df.shape[0]))
    ...
    #     dfsummary = dfsummary.append(df.groupby(['year'])['available'].agg(['count']).transpose(), ignore_index=True)
    #     index.append('+HTTP(200)')
    #     printf('filter 6: {}'.format(dfsummary.shape[0]))
    #
    #     dfsummary['index'] = index
    #     dfsummary.set_index('index', inplace=True)
    #
